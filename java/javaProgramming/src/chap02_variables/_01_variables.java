...
public class _01_variables {
	...
	public static void main(String[] args) {
		...
		// 1-5. 본인만 알아 볼 수 있는 뱐수명을 사용하지 않는다
		...
		// 2. 변수 사용
		// 2-1. 변수에 값 저장
		// 변수에 값을 최초로 저장(할당)하는 것을 초기화라고 한다.
		likeCnt = 1500;
		// 변수에 저장되어 있는 값의 사용
		...
		// 2-3.  선언된 변수에는 선언 시에 저장한 자료형의 값만 저장 할 수 있다.
//		studentCnt = 11.11
		
		// 2-4. 초기화(값이 저장되지 않은)되지 않은 변수를 사용하면 에러가 발생된다.
		int errorVal;
