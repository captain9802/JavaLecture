...
public class CarConstructor {
	...
	// 매개변수가 있는 생성자
	// 매개변수를 통해서 속성값들을 초기화 한다.
	// 매개변수 생성자에서 관례적으로 어떤 값을 초기화하느 변수인지를 명확하게 하기 위해서
	// 매개변수명을 속성변수명과 일치시켜준다.,
	public CarConstructor(String company, String model, String color, int price) {
	
	   // 매개 변수로 속성을 초기화 할 때 사용하는 this 객체
	   // this 객체는 생성된 이 클래스 객체를 지칭한다.
...
//	public CarConstructor(String c, String m, String col, int p) {
//		company = c;
//		model = m;
//		color = col;
//		price = p;
