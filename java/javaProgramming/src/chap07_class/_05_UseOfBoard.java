...
public class _05_UseOfBoard {
	...
	public static void main(String[] args) {
		...
		// 다라서 클래스는 사용자가 직접 만든 타입으로 생각해도 된다.
		// 보드 타입의 변수
		Board board;
		
		// 2. 클래스 내의 속성이나 기능들은 객체가 만들어진 후에 사용이 가능하고
	...
	public static void printBoardInfo(Board board) {
		...
		System.out.println("게시글 내용 : " + board.getBoardContent());
		System.out.println("게시글 작성자 : " + board.getBoardWritter());
	...
	public static Board of(int boardNo, String boardTitle, String boardContent, String boardWritter, String boardDate) {
		return new Board(boardNo, boardTitle,boardContent,boardWritter, boardDate);
	}
